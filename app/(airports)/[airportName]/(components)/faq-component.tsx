...
const AirportFaqComponent = ({i,question,answer}: Props) => {
  return (
    ...
    <AccordionTrigger className={cn("hover:no-underline py-8 font-bold px-4 text-site hover:bg-muted-foreground/40 transition text-start")}>{question}?</AccordionTrigger>
