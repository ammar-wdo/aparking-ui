...
if(!service) return {
  ...
  return {
    ...
    description:`${service.name} a ${service.parkingType} parking service, located just [${service.distanceToAirport} km away from ${service.entity.entityName}. Save time and book your parking spot now with Aparking. `,
