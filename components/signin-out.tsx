...
const SigninOut = ({ col, close }: Props) => {
  return (
    <div>
      ...
      <Link aria-label="Mijn reservering" className="text-site block md:hidden  p-1 rounded-full border-[#FEBA02] border-2 bg-[#FEBA02]" href={"/mijn-reservering"}><User  /></Link>
    </div>
  );
};
